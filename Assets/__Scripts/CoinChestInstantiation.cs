...
public class CoinChestInstantiation : MonoBehaviour
{
    ...
    void Start()
    {
        //Pre determined spawn points for coin spawn positions
        ...
        //Pre determinied spawn points for chest spawn positions
        chestSpawnPos = new Vector3[3];
